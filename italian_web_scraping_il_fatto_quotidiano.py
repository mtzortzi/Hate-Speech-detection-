...
"""
    Scrapes the Italian newspaper "Il Fatto Quotidiano"
...
numwords = 100
newspaper = 'il_fatto_quotidiano'

# Define the folder path containing the HTML files and the output CSV file
folder_path = r"C:/Users/MariaΙoannaTzortzi/OneDrive - ITML/AFRO_EQUALITY/New_Attempt/webpages_html/Italian/il_fatto_quotidiano"
...
for file_name in file_list:
    if file_name.endswith(".html"):  # Only process HTML files
        ...
        article_text = ""
        content_blocks = soup.find('section', class_='article-body')
        
        if content_blocks:
            content_section = content_blocks.find('section', class_='article-content')
            ...
            print(f"❌ Content container not found for: {file_name}")
...
# # Define the folder path containing the HTML files and the output CSV file
# folder_path = "C:/Users/MariaΙoannaTzortzi/OneDrive - ITML/AFRO_EQUALITY/New_Attempt/webpages_html/Italian/il_fatto_quotidiano"
# output_path = "C:/Users/MariaΙoannaTzortzi/OneDrive - ITML/AFRO_EQUALITY/New_Attempt/Datasets/Italian/"
...
#         content_blocks = soup.find('div', class_='article-wrapper')  # Adjust the class as per your HTML structure
#         article_text = ""
#         if content_blocks:
#             print('insideee1')
