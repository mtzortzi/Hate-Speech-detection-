...
folder_path = r"C:/Users/MariaΙoannaTzortzi/OneDrive - ITML/AFRO_EQUALITY/New_Attempt/webpages_html/Greek/ladylike/"
...
for file_name in file_list:
    ...
    if file_name.endswith(".html"):  # Only process HTML files
        ...
        entry_content = soup.find("section", class_="single_article__main_content")
        if entry_content:
