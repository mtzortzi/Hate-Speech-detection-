...
"""
    Scrapes the Italian newspaper "openpolis"
...
folder_path = r"C:/Users/MariaΙoannaTzortzi/OneDrive - ITML/AFRO_EQUALITY/New_Attempt/webpages_html/Italian/openpolis"
...
for file_name in file_list:
    if file_name.endswith(".html"):  # Only process HTML files
        ...
        content_blocks = soup.find("div", class_="content-body")
