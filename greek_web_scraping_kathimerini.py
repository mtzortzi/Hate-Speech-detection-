...
"""
    scrapes the greek newspaper "kathimerini"
...
folder_path = "C:/Users/MariaΙoannaTzortzi/OneDrive - ITML/AFRO_EQUALITY/New_Attempt/webpages_html/Greek/kathimerini"
...
for file_name in os.listdir(folder_path):
    if file_name.endswith(".html"):  # Only process HTML files
        ...
        content_blocks = soup.find('div', id='main-content')#class_='article-content')  # Adjust the class as per your HTML structure
        article_text = ""
        if content_blocks:
