...
"""
    Scrapes the Italian newspaper "ansa"
...
folder_path = r"C:/Users/MariaΙoannaTzortzi/OneDrive - ITML/AFRO_EQUALITY/New_Attempt/webpages_html/Italian/ansa"
...
for file_name in file_list:
    ...
    if file_name.endswith(".html"):  # Only process HTML files
        ...
        content_blocks = soup.find("div", class_="article-main")

        if content_blocks:
            print(f'✅ Found content grid')

            # Try other possible article content containers
            content_section = content_blocks.find("div", class_="post-single-text rich-text news-txt") or \
