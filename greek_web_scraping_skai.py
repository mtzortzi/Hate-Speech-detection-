...
"""
    Scrapes the Greek newspaper "skai"
...
folder_path = r"C:/Users/MariaΙoannaTzortzi/OneDrive - ITML/AFRO_EQUALITY/New_Attempt/webpages_html/Greek/skai/"
...
for file_name in file_list:
    ...
    if file_name.endswith(".html"):  # Only process HTML files
        ...
        content_blocks = soup.find(["article", "div"], class_="mb-30")

        if content_blocks:
            print(f'✅ Found content grid')
            # Find all <div class="item_text"> and <div class="item_text dropcap">
            text_blocks = content_blocks.find_all('div', class_=['post-content mb-30 border-box'])
