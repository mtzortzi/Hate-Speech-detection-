...
"""
    Scrapes the Greek newspaper "popaganda"
...
folder_path = r"C:/Users/MariaΙoannaTzortzi/OneDrive - ITML/AFRO_EQUALITY/New_Attempt/webpages_html/Greek/popaganda/"
...
for file_name in file_list:
    ...
    if file_name.endswith(".html"):  # Only process HTML files
        ...
        content_blocks = soup.find(["article", "div"], class_="default-post-main nxGrid")

        if content_blocks:
            print(f'✅ Found content grid')
            # Find all <div class="item_text"> and <div class="item_text dropcap">
            text_blocks = content_blocks.find_all('div', class_=['post-content big nxContent'])
